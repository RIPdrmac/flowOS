...
export const products: Product[] = [
  {
    ...
    launchSpotsLeft: 100,
    blocks: [
      { name: "Gig Booking Engine", description: "Clients book you directly. No more back-and-forth texts.", icon: "calendar" },
      { name: "Client Portal", description: "Every client sees their events, contracts, and invoices in one place.", icon: "users" },
      { name: "Rate Calculator", description: "Smart pricing based on event type, duration, travel, and equipment.", icon: "calculator" },
      { name: "Invoice & Payments", description: "Send invoices, collect deposits, track who owes you.", icon: "dollar" },
      { name: "Music Library Manager", description: "Organize your catalog by genre, BPM, energy level, and mood.", icon: "music" },
      { name: "Equipment Tracker", description: "Know what gear you have, what's out, and what needs maintenance.", icon: "speaker" },
      { name: "AI Event Planner", description: "Claude builds setlists, timelines, and event flow suggestions.", icon: "brain" },
      { name: "Review Collector", description: "Automatically request reviews after every gig.", icon: "star" },
    ],
    faqs: [
  ...
  },
  {
    ...
    launchSpotsLeft: 100,
    blocks: [
      { name: "Appointment Booking", description: "Clients book their own cuts. No more phone tag.", icon: "calendar" },
      { name: "Client Profiles", description: "Remember every client's cut, style preference, and product choice.", icon: "users" },
      { name: "Chair Revenue Tracker", description: "See exactly how much each chair generates daily, weekly, monthly.", icon: "chart" },
      { name: "No-Show Shield", description: "Automated reminders and deposit requirements kill no-shows.", icon: "shield" },
      { name: "Product Inventory", description: "Track products you sell and use. Know when to reorder.", icon: "box" },
      { name: "Loyalty System", description: "Reward regulars. Every 10th cut free. Your rules.", icon: "star" },
      { name: "AI Style Advisor", description: "Claude suggests styles based on face shape and trends.", icon: "brain" },
      { name: "Multi-Chair Management", description: "Run multiple barbers under one roof with individual tracking.", icon: "grid" },
    ],
    faqs: [
  ...
  },
  {
    ...
    launchSpotsLeft: 100,
    blocks: [
      { name: "Member Directory", description: "Every member, family, and visitor in one searchable system.", icon: "users" },
      { name: "Tithe & Donation Tracker", description: "Track giving, generate tax receipts, and see giving trends.", icon: "dollar" },
      { name: "Volunteer Coordinator", description: "Schedule volunteers, send reminders, and track participation.", icon: "calendar" },
      { name: "Service Planner", description: "Plan worship services, assign roles, and share run-of-show.", icon: "clipboard" },
      { name: "Group Manager", description: "Organize small groups, Bible studies, and ministry teams.", icon: "grid" },
      { name: "Communication Hub", description: "Send announcements, prayer requests, and event updates.", icon: "message" },
      { name: "AI Sermon Notes", description: "Claude helps organize sermon outlines and study materials.", icon: "brain" },
      { name: "Event Manager", description: "Plan church events, track RSVPs, and manage logistics.", icon: "star" },
    ],
    faqs: [
  ...
  },
  {
    ...
    launchSpotsLeft: 100,
    blocks: [
      { name: "Proposal Builder", description: "Create and send branded proposals that close deals.", icon: "clipboard" },
      { name: "Contract Generator", description: "AI-powered contracts that protect your scope and your money.", icon: "shield" },
      { name: "Invoice Engine", description: "Send invoices, track payments, automate follow-ups.", icon: "dollar" },
      { name: "Client Portal", description: "Clients see their projects, files, and invoices in one place.", icon: "users" },
      { name: "Project Tracker", description: "Track time, milestones, and deliverables per project.", icon: "chart" },
      { name: "Expense Logger", description: "Log expenses, categorize for taxes, see real profit.", icon: "calculator" },
      { name: "AI Scope Defender", description: "Claude flags scope creep and suggests change order language.", icon: "brain" },
      { name: "Tax Prep Dashboard", description: "Quarterly estimates, deduction tracking, export for your CPA.", icon: "grid" },
    ],
    faqs: [
  ...
  },
  {
    ...
    launchSpotsLeft: 100,
    blocks: [
      { name: "Lead Pipeline", description: "Track every lead from first contact to closing day.", icon: "chart" },
      { name: "Listing Manager", description: "Manage all your listings, photos, and showing schedules.", icon: "grid" },
      { name: "Follow-Up Automator", description: "Automated drip sequences that keep you top of mind.", icon: "message" },
      { name: "Commission Calculator", description: "See your cut on every deal before it closes.", icon: "calculator" },
      { name: "Client Portal", description: "Buyers and sellers see their deals, docs, and timelines.", icon: "users" },
      { name: "Open House Tracker", description: "Capture leads at open houses and auto-add to pipeline.", icon: "calendar" },
      { name: "AI Market Reporter", description: "Claude generates neighborhood market reports for your clients.", icon: "brain" },
      { name: "Transaction Coordinator", description: "Track every document, deadline, and contingency to closing.", icon: "clipboard" },
    ],
    faqs: [
  ...
  },
  {
    ...
    launchSpotsLeft: 100,
    blocks: [
      { name: "Session Scheduler", description: "Clients book sessions based on your real availability.", icon: "calendar" },
      { name: "Client Journey Tracker", description: "Track goals, milestones, and breakthroughs per client.", icon: "chart" },
      { name: "Program Builder", description: "Create and sell coaching programs with structured modules.", icon: "grid" },
      { name: "Payment Manager", description: "Packages, subscriptions, and one-time payments handled.", icon: "dollar" },
      { name: "Session Notes", description: "Keep detailed notes linked to each client and session.", icon: "clipboard" },
      { name: "Resource Library", description: "Share worksheets, videos, and resources with clients.", icon: "box" },
      { name: "AI Insight Engine", description: "Claude identifies patterns and suggests coaching strategies.", icon: "brain" },
      { name: "Community Hub", description: "Create group spaces for cohorts and mastermind programs.", icon: "users" },
    ],
    faqs: [
  ...
  },
  {
    ...
    launchSpotsLeft: 100,
    blocks: [
      { name: "Job Scheduler", description: "Schedule jobs, assign crews, and optimize routes.", icon: "calendar" },
      { name: "Client Manager", description: "Every client, address, access code, and preference stored.", icon: "users" },
      { name: "Crew Dashboard", description: "Your team sees their schedule, checklists, and job details.", icon: "grid" },
      { name: "Recurring Jobs", description: "Set it and forget it. Weekly, biweekly, monthly auto-scheduling.", icon: "chart" },
      { name: "Supply Tracker", description: "Know what you have, what you need, and what each job costs.", icon: "box" },
      { name: "Quote Builder", description: "Generate professional quotes based on square footage and scope.", icon: "calculator" },
      { name: "AI Route Optimizer", description: "Claude plans the most efficient route for your day.", icon: "brain" },
      { name: "Quality Checklist", description: "Photo verification and checklists ensure every job meets standards.", icon: "clipboard" },
    ],
    faqs: [
  ...
  },
  {
    ...
    launchSpotsLeft: 100,
    blocks: [
      { name: "Session Scheduler", description: "Students and parents book based on your real availability.", icon: "calendar" },
      { name: "Student Profiles", description: "Track each student's level, goals, strengths, and areas to improve.", icon: "users" },
      { name: "Progress Reports", description: "Generate and share progress updates with parents automatically.", icon: "chart" },
      { name: "Lesson Planner", description: "Plan lessons, attach resources, and track curriculum coverage.", icon: "clipboard" },
      { name: "Payment & Packages", description: "Sell session packages, track payments, send invoices.", icon: "dollar" },
      { name: "Resource Library", description: "Organize and share worksheets, practice tests, and materials.", icon: "box" },
      { name: "AI Study Planner", description: "Claude creates personalized study plans based on student data.", icon: "brain" },
      { name: "Parent Portal", description: "Parents see schedules, progress, and payment history.", icon: "shield" },
    ],
    faqs: [
